...
{
/*! firebase-admin v13.5.0 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/buffer/index.js [app-client] (ecmascript)");
"use strict";
/*!
 * @license
...
var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
/*! firebase-admin v13.5.0 */ "use strict";
/*!
 * @license
 * Copyright 2017 Google Inc.
 *
...
class FirebaseMessagingSessionError extends FirebaseMessagingError {
    /**
       ...
       */ constructor(info, message, pendingBatchResponse){
        ...
        /* tslint:disable:max-line-length */ // Set the prototype explicitly. See the following link for more details:
        // https://github.com/Microsoft/TypeScript/wiki/Breaking-Changes#extending-built-ins-like-error-array-and-map-may-no-longer-work
        /* tslint:enable:max-line-length */ this.__proto__ = FirebaseMessagingSessionError.prototype;
    }
    /** @returns The object representation of the error. */ toJSON() {
        return {
            code: this.code,
...
var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
/*! firebase-admin v13.5.0 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
"use strict";
/*!
 * @license
...
const fastDeepEqual = __turbopack_context__.r("[project]/node_modules/fast-deep-equal/index.js [app-client] (ecmascript)");
        ...
        if (!this.http2Session || this.isClosed) {
            ...
            http2Session.on('error', (error)=>{
                ...
                if (error.name == 'AggregateError' && error.errors) {
                    errorMessage = `Session error while making requests: ${error.code} - ${error.name}: ` + `[${error.errors.map((error)=>error.message).join(', ')}]`;
                } else {
...
class DatabaseService {
    ...
    getDatabase(url) {
        ...
        if (typeof db === 'undefined') {
            // eslint-disable-next-line @typescript-eslint/no-var-requires
            const rtdb = __turbopack_context__.r("[project]/node_modules/@firebase/database-compat/dist/index.standalone.js [app-client] (ecmascript)");
...
const standalone_1 = __turbopack_context__.r("[project]/node_modules/@firebase/database-compat/dist/index.standalone.js [app-client] (ecmascript)");
const app_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app/index.js [app-client] (ecmascript)");
...
Object.defineProperty(exports, "RemoteConfigFetchResponse", {
    enumerable: true,
    get: function() {
        return remote_config_2.RemoteConfigFetchResponse;
    }
});
/**
 ...
 */ class FirebaseNamespace {
     ...
     */ get database() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        return Object.assign(fn, __turbopack_context__.r("[project]/node_modules/@firebase/database-compat/dist/index.standalone.js [app-client] (ecmascript)"));
    }
    /**
...
//# sourceMappingURL=node_modules_firebase-admin_7bff1275._.js.map