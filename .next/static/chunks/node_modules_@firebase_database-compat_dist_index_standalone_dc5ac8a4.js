...
"[project]/node_modules/@firebase/database-compat/dist/index.standalone.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var require$$2$3 = __turbopack_context__.r("[project]/node_modules/@firebase/util/dist/index.cjs.js [app-client] (ecmascript)");
var require$$1$3 = __turbopack_context__.r("[project]/node_modules/@firebase/logger/dist/index.cjs.js [app-client] (ecmascript)");
var require$$0$2 = __turbopack_context__.r("[project]/node_modules/@firebase/component/dist/index.cjs.js [app-client] (ecmascript)");
...
var base = Base$7;
var httpParser = {};
/*jshint node:true */ httpParser.HTTPParser = HTTPParser;
...
for(var key$6 in instance$6)Proxy$2.prototype[key$6] = instance$6[key$6];
var proxy = Proxy$2;
var Buffer$3 = safeBuffer.exports.Buffer, crypto$1 = require$$1__default$1["default"], url$1 = require$$2__default$1["default"], util$8 = require$$2__default["default"], HttpParser$1 = http_parser, Base$4 = base, Hybi$1 = hybi, Proxy$1 = proxy;
 ...
 */ registerCoreComponents('node');
    Object.defineProperty(exports1, 'FirebaseError', {
        enumerable: true,
        get: function() {
            return util.FirebaseError;
        }
    });
    exports1.SDK_VERSION = SDK_VERSION;
    exports1._DEFAULT_ENTRY_NAME = DEFAULT_ENTRY_NAME;
    exports1._addComponent = _addComponent;
    exports1._addOrOverwriteComponent = _addOrOverwriteComponent;
    exports1._apps = _apps;
    exports1._clearComponents = _clearComponents;
    exports1._components = _components;
    exports1._getProvider = _getProvider;
    exports1._isFirebaseApp = _isFirebaseApp;
    exports1._isFirebaseServerApp = _isFirebaseServerApp;
    exports1._registerComponent = _registerComponent;
    exports1._removeServiceInstance = _removeServiceInstance;
    exports1._serverApps = _serverApps;
    exports1.deleteApp = deleteApp;
    exports1.getApp = getApp;
    exports1.getApps = getApps;
    exports1.initializeApp = initializeApp;
    exports1.initializeServerApp = initializeServerApp;
    exports1.onLog = onLog;
    exports1.registerVersion = registerVersion;
    exports1.setLogLevel = setLogLevel;
})(index_cjs);
 ...
 */ class AppCheckTokenProvider {
    ...
    notifyForInvalidToken() {
        warn$1(`Provided AppCheck credentials for the app named "${this.appName}" ` + 'are invalid. This usually indicates your app was not initialized correctly.');
    }
}
/**
 * @license
 ...
 */ function query(query1, ...queryConstraints) {
    let queryImpl = util.getModularInstance(query1);
 ...
 */ function connectDatabaseEmulator(db, host, port, options = {}) {
    ...
    if (db._instanceStarted) {
        ...
        if (hostAndPort === db._repoInternal.repoInfo_.host && util.deepEqual(options, repo.repoInfo_.emulatorOptions)) {
            return;
        }
...
const validateEventType = function(fnName, eventType, optional) {
    ...
    switch(eventType){
        ...
        case 'child_moved':
            break;
        default:
            throw new Error(require$$2$3.errorPrefix(fnName, 'eventType') + 'must be a valid event type = "value", "child_added", "child_removed", ' + '"child_changed", or "child_moved".');
    }
};
/**
 * @license
    ...
    on(eventType, callback, cancelCallbackOrContext, context) {
        ...
        switch(eventType){
            ...
            case 'child_moved':
                ...
                return callback;
            default:
                throw new Error(require$$2$3.errorPrefix('Query.on', 'eventType') + 'must be a valid event type = "value", "child_added", "child_removed", ' + '"child_changed", or "child_moved".');
        }
    }
    off(eventType, callback, context) {
     ...
     */ once(eventType, callback, failureCallbackOrContext, context) {
        ...
        switch(eventType){
            ...
            case 'child_moved':
                ...
                break;
            default:
                throw new Error(require$$2$3.errorPrefix('Query.once', 'eventType') + 'must be a valid event type = "value", "child_added", "child_removed", ' + '"child_changed", or "child_moved".');
        }
        return deferred.promise;
    }
    /**
     ...
     */ static getCancelAndContextArgs_(fnName, cancelOrContext, context) {
        ...
        if (cancelOrContext && context) {
            ...
            if (typeof cancelOrContext === 'object' && cancelOrContext !== null) {
                ...
                throw new Error(require$$2$3.errorPrefix(fnName, 'cancelOrContext') + ' must either be a cancel callback or a context object.');
            }
        }
        return ret;
    }
...
//# sourceMappingURL=node_modules_%40firebase_database-compat_dist_index_standalone_dc5ac8a4.js.map