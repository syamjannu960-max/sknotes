...
"[project]/src/lib/firebase-admin.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apps"].length) {
    try {
        ...
        const serviceAccountString = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GOOGLE_APPLICATION_CREDENTIALS, 'base64').toString('utf8');
        const serviceAccount = JSON.parse(serviceAccountString);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeApp"])({
            credential: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["credential"].cert(serviceAccount)
        });
    } catch (error) {
        console.error('Firebase admin initialization error', error.stack);
    }
}
const adminDb = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestore"])();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase-admin.ts [app-client] (ecmascript)");
;
...
async function getCourses() {
    const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(coursesCollection).get();
...
async function getCourseBySlug(slug) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(coursesCollection).where("slug", "==", slug);
...
async function getCourseById(id) {
    const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(coursesCollection).doc(id);
...
async function getSemesters() {
    const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(semestersCollection).get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
        }));
...
async function getSemesterBySlug(slug) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(semestersCollection).where("slug", "==", slug);
    const snapshot = await q.get();
    if (snapshot.empty) return undefined;
    const doc = snapshot.docs[0];
    return {
...
async function getSemesterById(id) {
    const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(semestersCollection).doc(id);
    const docSnap = await docRef.get();
    if (!docSnap.exists) return undefined;
    return {
        ...docSnap.data(),
...
async function getSemestersForCourse(courseId) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).where("courseId", "==", courseId);
    const snapshot = await q.get();
    const semesterIds = [
        ...new Set(snapshot.docs.map((doc)=>doc.data().semesterId))
    ];
    if (semesterIds.length === 0) return [];
    const semestersQuery = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(semestersCollection).where('__name__', 'in', semesterIds);
...
async function getChaptersForSemester(courseId, semesterId) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).where("courseId", "==", courseId).where("semesterId", "==", semesterId);
    const snapshot = await q.get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
...
async function getChapters() {
    const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
        }));
...
async function getChapterBySlug(slug) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).where("slug", "==", slug);
    const snapshot = await q.get();
    if (snapshot.empty) return undefined;
    const doc = snapshot.docs[0];
    return {
...
async function getChapterById(id) {
    const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).doc(id);
    const docSnap = await docRef.get();
    if (!docSnap.exists) return undefined;
    return {
        ...docSnap.data(),
...
async function getUnitsForChapter(chapterId) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(unitsCollection).where("chapterId", "==", chapterId);
    const snapshot = await q.get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
...
async function getUnits() {
    const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(unitsCollection).get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
        }));
...
async function getUnitBySlug(slug, chapterId) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(unitsCollection).where("slug", "==", slug).where("chapterId", "==", chapterId);
    const snapshot = await q.get();
    if (snapshot.empty) return undefined;
    const doc = snapshot.docs[0];
    return {
...
async function getUnitById(id) {
    const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDb"].collection(unitsCollection).doc(id);
    const docSnap = await docRef.get();
    if (!docSnap.exists) return undefined;
    return {
        ...docSnap.data(),
...
//# sourceMappingURL=src_4d08fb42._.js.map