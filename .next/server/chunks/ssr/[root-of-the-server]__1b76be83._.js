...
"[project]/src/lib/firebase-admin.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
if (!__TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin__$5b$external$5d$__$28$firebase$2d$admin$2c$__cjs$29$__["apps"].length) {
    try {
        ...
        const serviceAccountString = Buffer.from(process.env.GOOGLE_APPLICATION_CREDENTIALS, 'base64').toString('utf8');
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase-admin.ts [app-ssr] (ecmascript)");
;
...
async function getCourses() {
    const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(coursesCollection).get();
...
async function getCourseBySlug(slug) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(coursesCollection).where("slug", "==", slug);
...
async function getCourseById(id) {
    const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(coursesCollection).doc(id);
...
async function getSemesters() {
    const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(semestersCollection).get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
        }));
...
async function getSemesterBySlug(slug) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(semestersCollection).where("slug", "==", slug);
    const snapshot = await q.get();
    if (snapshot.empty) return undefined;
    const doc = snapshot.docs[0];
    return {
...
async function getSemesterById(id) {
    const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(semestersCollection).doc(id);
    const docSnap = await docRef.get();
    if (!docSnap.exists) return undefined;
    return {
        ...docSnap.data(),
...
async function getSemestersForCourse(courseId) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).where("courseId", "==", courseId);
    const snapshot = await q.get();
    const semesterIds = [
        ...new Set(snapshot.docs.map((doc)=>doc.data().semesterId))
    ];
    if (semesterIds.length === 0) return [];
    const semestersQuery = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(semestersCollection).where('__name__', 'in', semesterIds);
...
async function getChaptersForSemester(courseId, semesterId) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).where("courseId", "==", courseId).where("semesterId", "==", semesterId);
    const snapshot = await q.get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
...
async function getChapters() {
    const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
        }));
...
async function getChapterBySlug(slug) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).where("slug", "==", slug);
    const snapshot = await q.get();
    if (snapshot.empty) return undefined;
    const doc = snapshot.docs[0];
    return {
...
async function getChapterById(id) {
    const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(chaptersCollection).doc(id);
    const docSnap = await docRef.get();
    if (!docSnap.exists) return undefined;
    return {
        ...docSnap.data(),
...
async function getUnitsForChapter(chapterId) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(unitsCollection).where("chapterId", "==", chapterId);
    const snapshot = await q.get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
...
async function getUnits() {
    const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(unitsCollection).get();
    return snapshot.docs.map((doc)=>({
            ...doc.data(),
            id: doc.id
        }));
...
async function getUnitBySlug(slug, chapterId) {
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(unitsCollection).where("slug", "==", slug).where("chapterId", "==", chapterId);
    const snapshot = await q.get();
    if (snapshot.empty) return undefined;
    const doc = snapshot.docs[0];
    return {
...
async function getUnitById(id) {
    const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminDb"].collection(unitsCollection).doc(id);
    const docSnap = await docRef.get();
    if (!docSnap.exists) return undefined;
    return {
        ...docSnap.data(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1b76be83._.js.map