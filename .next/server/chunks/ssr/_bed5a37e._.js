...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"400651fd469cb671660422867061720947fd9fc1dc":"deleteUnit","4014b090a06a97ceb49b48f3be3e064facb9893d63":"addChapter","4036f5c243be6fc6adc3a6f47fb502bf42d53ec960":"updateCourse","404fc726e8e39c193898bd5e7669906c08add30f28":"deleteSemester","40551febb87fa9e9cd2545cf19068519d153f00156":"updateUnit","40580725355c614a27107521361695b45429a2bf91":"updateSemester","40683cb46383eef4471608f732328e6ca7be2c5fe3":"addSemester","407f7c44cdd6e974a8e1d631b79abff724cc7ce490":"updateChapter","40876b3ef803aca13c15e5a7986640c909a8db249b":"addUnit","40a2d49b631ffae968360ec5c5e6c381f9a1f81e4f":"deleteCourse","40af762e45d47a4564fe2dceaa6ed268ae7f59b9df":"deleteChapter","40d22acf6c44f9633eadc575eda839e3c133e11986":"addCourse"},"",""] */ __turbopack_context__.s({
...
async function updateCourse(values) {
    ...
    if (!values.id) {
        return {
            success: false,
            error: "Course ID is required for an update."
        };
    }
...
async function addChapter(values) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["chapters"].push(newChapter);
...
async function updateChapter(values) {
    ...
    if (!values.id) {
        return {
            success: false,
            error: "Chapter ID is required for an update."
        };
    }
    const chapter = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["chapters"].find((c)=>c.id === values.id);
    if (chapter) {
...
async function deleteChapter(id) {
    await delay(500);
    const index = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["chapters"].findIndex((c)=>c.id === id);
    if (index > -1) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["chapters"].splice(index, 1);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/admin/chapters");
        return {
            success: true
        };
...
async function addUnit(values) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["units"].push(newUnit);
...
async function updateUnit(values) {
    ...
    if (!values.id) {
        return {
            success: false,
            error: "Unit ID is required for an update."
        };
    }
    const unit = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["units"].find((u)=>u.id === values.id);
    if (unit) {
        Object.assign(unit, {
            ...values,
            slug: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["slugify"])(values.title)
...
async function deleteUnit(id) {
    await delay(500);
    const index = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["units"].findIndex((u)=>u.id === id);
    if (index > -1) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["units"].splice(index, 1);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/admin/units");
        return {
            success: true
        };
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateChapter, "407f7c44cdd6e974a8e1d631b79abff724cc7ce490", null);
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateUnit, "40551febb87fa9e9cd2545cf19068519d153f00156", null);
...
{
__turbopack_context__.s({
    "4036f5c243be6fc6adc3a6f47fb502bf42d53ec960": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateCourse"]),
...
{
__turbopack_context__.s({
    "4036f5c243be6fc6adc3a6f47fb502bf42d53ec960": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$admin$2f$courses$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["4036f5c243be6fc6adc3a6f47fb502bf42d53ec960"]),
...
//# sourceMappingURL=_bed5a37e._.js.map